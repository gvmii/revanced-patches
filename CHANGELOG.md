...
*  `autorepeat-by-default` patch ([#148](https://github.com/gvmii/revanced-patches/issues/148)) ([fe628ba](https://github.com/gvmii/revanced-patches/commit/fe628ba909d89ea0bf3d95fe94ca78ef819677da))
* `codecs-unlock` patch and update Music patches to `5.14.53` ([2437d30](https://github.com/gvmii/revanced-patches/commit/2437d3070f6a630d353619f642cefebd47abee20))
* `create-button-signature` ([a173f6e](https://github.com/gvmii/revanced-patches/commit/a173f6e5a7e65943657e2072e8a72a4a680e5277))
* `custom-branding` patch failing to get resources ([efb6d4c](https://github.com/gvmii/revanced-patches/commit/efb6d4c2be515185fc9bd29c40ce202f0d684cee))
* `default-video-quality` patch crashing ([#227](https://github.com/gvmii/revanced-patches/issues/227)) ([379327a](https://github.com/gvmii/revanced-patches/commit/379327a6b2325ef93c7107472343dd9fd85a0f56))
* `disable-create-button` not working with prebuilt jar file ([#55](https://github.com/gvmii/revanced-patches/issues/55)) ([78be64a](https://github.com/gvmii/revanced-patches/commit/78be64accc2023281c0c376849cdb0213622dc5c))
* `enable-seekbar-tapping` patch ([52fd726](https://github.com/gvmii/revanced-patches/commit/52fd726d9b0d2efbd0f9742fc84ad01ccdcff168))
* `exclusive-audio-playback` patch ([#153](https://github.com/gvmii/revanced-patches/issues/153)) ([9beff95](https://github.com/gvmii/revanced-patches/commit/9beff9567f1586e5c58690c1f1d2f7f204025ab7))
* `hrd-auto-brightness` ([#152](https://github.com/gvmii/revanced-patches/issues/152)) ([5f2e9ba](https://github.com/gvmii/revanced-patches/commit/5f2e9ba30b7432be04bdc9f9f7ec7ac75fdc4b34))
* `Index` in wrong package ([2f9360f](https://github.com/gvmii/revanced-patches/commit/2f9360f57cc8415564534fbbd8bd5e2a83a1b629))
* `minimized-playback` & `old-quality-layout` wrong opcodes ([b45d175](https://github.com/gvmii/revanced-patches/commit/b45d175c6f1ece6da894ab16128c2644d262c9c7))
* `minimized-playback` patch ([55677a4](https://github.com/gvmii/revanced-patches/commit/55677a44ff965c0b92c3f1d771bd68c12c142ad4))
* `minimized-playback` patch for YouTube Kids videos ([#201](https://github.com/gvmii/revanced-patches/issues/201)) ([31e3b42](https://github.com/gvmii/revanced-patches/commit/31e3b42c6bbce0d00f049b8a69bafc94900bb3b4))
* `old-quality-layout` patch ([2497425](https://github.com/gvmii/revanced-patches/commit/2497425c9f11b8b14c861c2f0f34ff47bdbfac53))
* `SignatureChecker` not handling nullable field `methodMetadata` ([17bcf78](https://github.com/gvmii/revanced-patches/commit/17bcf786a85ccf1f7d9f5a66a044a3c26def09bb))
* `swipe-controls` with active engagement panel ([#177](https://github.com/gvmii/revanced-patches/issues/177)) ([000ec6d](https://github.com/gvmii/revanced-patches/commit/000ec6d8f6ecbb910a06ec852564ee9e5f03dcf8))
* accidentally removed code in refactor ([0077e26](https://github.com/gvmii/revanced-patches/commit/0077e26d23cc112b671a41614a55348fac2c88ca))
* actually call `VideoInformation.setCurrentVideoId` first ([5c62d0a](https://github.com/gvmii/revanced-patches/commit/5c62d0a2e0217de1b9563a41b4e94ed63230440f))
* add 17.25.34 as supported version for swipe-controls patch ([4d84c19](https://github.com/gvmii/revanced-patches/commit/4d84c1914f8ecf51cee25667219bc6cf635a6c1c))
* add execute permission to `./gradlew` file ([ff7a560](https://github.com/gvmii/revanced-patches/commit/ff7a5602f68428111fea6c60cbea694592039ef1))
* add missing `trimIndent()` to string literals ([76d3c71](https://github.com/gvmii/revanced-patches/commit/76d3c71b67edebd79f2cdb1bb28e4d2969d72223))
* add missing opcode for `create-button-method` ([0a398ef](https://github.com/gvmii/revanced-patches/commit/0a398ef364f91a0dd9608df1a036a2515476ccf2))
* add missing permission to reboot app ([#260](https://github.com/gvmii/revanced-patches/issues/260)) ([6ced6df](https://github.com/gvmii/revanced-patches/commit/6ced6df8ed7642dea51e1acd1c12f4de4874b972))
* add missing switch for tablet mini-player ([b824d35](https://github.com/gvmii/revanced-patches/commit/b824d35960df9e99c2a2d248356c3c9342cfe130))
* add size `48px` for `custom-branding` patch ([f81872b](https://github.com/gvmii/revanced-patches/commit/f81872b8e41da215517fdb59364130d8ce681607))
* add v17.28.34 compatiblity for the `hide-shorts-button` patch ([#224](https://github.com/gvmii/revanced-patches/issues/224)) ([76166bb](https://github.com/gvmii/revanced-patches/commit/76166bb35f940ef661e2802f5bf93ed91f2e2913))
* attempt on all patches ([3395d69](https://github.com/gvmii/revanced-patches/commit/3395d69747103a4bdf314297aa0bfa6ef6a0fc36))
* autoplay not working. ([586eed5](https://github.com/gvmii/revanced-patches/commit/586eed515fc7ff8e3b1b150b0d34610b39480bb5))
* autoplay still enabled when using patch ([4f96129](https://github.com/gvmii/revanced-patches/commit/4f961298f6cb6417ee3f3d6f8ac7ce96594ed03b))
* breaking changes by `revanced-patcher` dependency ([e12e484](https://github.com/gvmii/revanced-patches/commit/e12e484e3796c5c9c8505b677838cdf8432f2e79))
* breaking changes by `revanced-patcher` dependency ([7e485b4](https://github.com/gvmii/revanced-patches/commit/7e485b4ffe204d724809aeb9bd9f693a35ded94d))
* breaking changes of the patcher ([1a49bbd](https://github.com/gvmii/revanced-patches/commit/1a49bbdbc4ff6f427934259536218e161908b449))
* breaking patcher changes ([50f9cc5](https://github.com/gvmii/revanced-patches/commit/50f9cc52acfd5bc23330ecd23d8d85678a9d3eee))
* breaking patcher changes ([cbb9e2c](https://github.com/gvmii/revanced-patches/commit/cbb9e2cd1fa829e1d1dd92dbd40131b11ae6a05b))
* breaking patcher changes ([581d1b0](https://github.com/gvmii/revanced-patches/commit/581d1b0ca7d15adcdb1ab6116ef035acfe701757))
* broken gradle task ([91483a8](https://github.com/gvmii/revanced-patches/commit/91483a8fbf92559d079dc52f846f5f871f5d6b5c))
* broken gradle task ([4d07961](https://github.com/gvmii/revanced-patches/commit/4d07961c8afd24da7f8879d11419147f2e100f05))
* broken gradle task ([28e3f55](https://github.com/gvmii/revanced-patches/commit/28e3f554ea6a7144416523fe48ce7adbb613b263))
* bugfixes in `microg` ([a43b33b](https://github.com/gvmii/revanced-patches/commit/a43b33bdbb2b36e0a8f991fa11dfeeec34de01f9))
* bump youtube version for swipe-controls patch ([ff207a5](https://github.com/gvmii/revanced-patches/commit/ff207a57af7d3c15a8127f4465e97da23878b0d6))
* bump youtube version to 17.27.39 ([b93401a](https://github.com/gvmii/revanced-patches/commit/b93401a391c0ed4887dd1376ac253f74f98a8d7e))
* bump youtube version to 17.28.34 ([#225](https://github.com/gvmii/revanced-patches/issues/225)) ([738cb6a](https://github.com/gvmii/revanced-patches/commit/738cb6af177e92bbff8c02d6808fe416c0ad2582))
* bump youtube version to 17.29.34 ([#236](https://github.com/gvmii/revanced-patches/issues/236)) ([be6494a](https://github.com/gvmii/revanced-patches/commit/be6494a80989044cba961dc22fc58ffb2e8591f0))
* change fingerprint to work on latest youtube ([#80](https://github.com/gvmii/revanced-patches/issues/80)) ([4dba323](https://github.com/gvmii/revanced-patches/commit/4dba323ddf8980cd2b0908a0de41c4b4dea6b0d7))
* check if node has attributes before accessing them ([2d2ed87](https://github.com/gvmii/revanced-patches/commit/2d2ed870dacfe092eb6acbcaae5e51775c611322))
* check if resource files exist ([ba1f3af](https://github.com/gvmii/revanced-patches/commit/ba1f3af99be58edc44ed1b8f1875508d5034efd8))
* clean after building ([a2df3fb](https://github.com/gvmii/revanced-patches/commit/a2df3fbc9761b07f3010542fa8684ade00e4dc91))
* compatibility of `force-vp9-codec-parent-fingerprint` fingerprint with version `17.27.39` ([523fd86](https://github.com/gvmii/revanced-patches/commit/523fd8627bc965a724267f725c28fba5e7a25a04))
* constrain `old-quality-layout` to older version ([add7232](https://github.com/gvmii/revanced-patches/commit/add72326199e90f677b450b553b9d88c0bb4c490))
* crash when using force-vp9-codec patch ([7a35e5c](https://github.com/gvmii/revanced-patches/commit/7a35e5c985b412d5a84083d1416d3207a40b3e97))
* disable `hide-suggestions-patch` patch until fixed ([99099ea](https://github.com/gvmii/revanced-patches/commit/99099ea0bc12f5f25896967db642442df69d0c4f))
* disable cast modules in YouTube Music ([#337](https://github.com/gvmii/revanced-patches/issues/337)) ([86eaba8](https://github.com/gvmii/revanced-patches/commit/86eaba8248100987f46540a224956099bcf9da2c))
* disable-fullscreen-panels patch not working ([#213](https://github.com/gvmii/revanced-patches/issues/213)) ([5372105](https://github.com/gvmii/revanced-patches/commit/5372105e72607f289b779e4c2a3c13f3458842ce))
* display codename for patch names ([10c53f7](https://github.com/gvmii/revanced-patches/commit/10c53f720df3e70b9d59e8bc3219d56b996f03db))
* dummy task for Gradle semantic-release plugin ([f6a8911](https://github.com/gvmii/revanced-patches/commit/f6a8911906dfe52fcdb685daf7a02d6d0052cba9))
* environment variable not found in gradle build script ([0da15fb](https://github.com/gvmii/revanced-patches/commit/0da15fb0effac0566d080d7b85e9fbe46c3dd34d))
* exclude `swipe-controls` by default due to instability ([bdeb8e0](https://github.com/gvmii/revanced-patches/commit/bdeb8e04609a0ca94d9e2921bf7d486b9e229cec))
* forgot about this ([7102a25](https://github.com/gvmii/revanced-patches/commit/7102a25dc618f19b324b01870d23f5418f375b2a))
* freezing panels when watching video in fullscreen ([#89](https://github.com/gvmii/revanced-patches/issues/89)) ([f5d4f6c](https://github.com/gvmii/revanced-patches/commit/f5d4f6c3419916c6a9cf67babc6be8a64c854d3b))
* get create button view register by more reliable means ([#59](https://github.com/gvmii/revanced-patches/issues/59)) ([6ab821e](https://github.com/gvmii/revanced-patches/commit/6ab821e377176f4e9f1b7ec2b58a924fa40299db))
* incorrect compatibilty attribute ([#296](https://github.com/gvmii/revanced-patches/issues/296)) ([0ab3e97](https://github.com/gvmii/revanced-patches/commit/0ab3e9724157c628555964273c6b65f9f48f9664))
* incorrect endIndex (fixed in Patcher) ([424788e](https://github.com/gvmii/revanced-patches/commit/424788edd777110cdaff97500556d18628f33385))
* incorrect fingerprint version [skip ci] ([f8c62ae](https://github.com/gvmii/revanced-patches/commit/f8c62ae16b088ff6d0e96a4ef62dc707cd83beb9))
* incorrect package name in gradle task ([152b2c9](https://github.com/gvmii/revanced-patches/commit/152b2c90cf102170648fcc168da10f46743bdc63))
* invalid regex ([26bf1d8](https://github.com/gvmii/revanced-patches/commit/26bf1d818f953abc061126d8b91f17cd9008ba1d))
* invalid string in strings list ([f08b53b](https://github.com/gvmii/revanced-patches/commit/f08b53b07d93bd8ac6e7da376ea6e6023e53076e))
* invalid version in compatibility annotation ([#90](https://github.com/gvmii/revanced-patches/issues/90)) ([df43547](https://github.com/gvmii/revanced-patches/commit/df435475cdd0494a1e4ea9e2980c2998c9bc7048))
* listing of wrong fingerprint class ([#147](https://github.com/gvmii/revanced-patches/issues/147)) ([95c2bbd](https://github.com/gvmii/revanced-patches/commit/95c2bbdd1deb1d76f1177b48286fa6a3bc9f7663))
* loop in `amoled` patch ([c4c86b6](https://github.com/gvmii/revanced-patches/commit/c4c86b65fd8b2463c1d86ad2e46ec9f08e60d47c))
* make `minimized-playback-manager-fingerprint` unique ([#120](https://github.com/gvmii/revanced-patches/issues/120)) ([cd5e911](https://github.com/gvmii/revanced-patches/commit/cd5e911f4ed9ad95b02c13c30cd9466d250e8904))
* make all patches toggleable with settings ([#202](https://github.com/gvmii/revanced-patches/issues/202)) ([7e1d82f](https://github.com/gvmii/revanced-patches/commit/7e1d82f1161237632c3a57f109db6b8903006b33))
* migrate patches to latest patcher api changes ([8a0ee03](https://github.com/gvmii/revanced-patches/commit/8a0ee03a71cf4a000c9a7246d0e64ed8291a5127))
* migrate to `include` annotation ([110bbf1](https://github.com/gvmii/revanced-patches/commit/110bbf143a9cec8dce1f0416cff40f8d93055e96))
* migrate to breaking changes from patcher ([2c0a419](https://github.com/gvmii/revanced-patches/commit/2c0a4196fed2fbdcd454ed882b720898d3050c51))
* migrate to new `proxy` api ([db32ffe](https://github.com/gvmii/revanced-patches/commit/db32ffe56a8e73177bef724ee10eda9a28b367b8))
* migrate to new patcher api ([f43446e](https://github.com/gvmii/revanced-patches/commit/f43446ed189e583302fcd899f5eb7517f2a77144))
* missing brackets at inlining ([8936c8a](https://github.com/gvmii/revanced-patches/commit/8936c8aaedb56817cda5eec5f4a8c32f433862aa))
* missing extension method `doRecursively` ([e9c9460](https://github.com/gvmii/revanced-patches/commit/e9c946008ee912652d288e515b83b52ae2d239d8))
* modified opcode for `show-video-ads-constructor` ([a0dcea3](https://github.com/gvmii/revanced-patches/commit/a0dcea3a13f68cae449dfaf445b542e339c83ff0))
* multiple bugs in patches ([e37201d](https://github.com/gvmii/revanced-patches/commit/e37201d0ceef474696857a0d8845950c888194d0))
* name for `IntegrationsPatch` ([e46ef02](https://github.com/gvmii/revanced-patches/commit/e46ef02302825d62b57912b2747a25f858036bb7))
* old usage of `toInstructions` extension method ([65ddd52](https://github.com/gvmii/revanced-patches/commit/65ddd522dca19e0590d9cb6fdb2d85ad7b98481e))
* patch description consistency ([#134](https://github.com/gvmii/revanced-patches/issues/134)) ([da5896d](https://github.com/gvmii/revanced-patches/commit/da5896dde0a2b2b9ffe65e486402e4ef92ec1ce9))
* patcher not propagating dexlib ([980c486](https://github.com/gvmii/revanced-patches/commit/980c48673259496d793bc7f864ad355188dcf7b6))
* print instruction index of warning ([9e29aee](https://github.com/gvmii/revanced-patches/commit/9e29aeeeff222412f6c45cf7e4879f8ec53ca6ee))
* publish releases ([83916f9](https://github.com/gvmii/revanced-patches/commit/83916f96d27989dcbb35c0ba6ef326a16b470501))
* put back proper variable ([#61](https://github.com/gvmii/revanced-patches/issues/61)) ([d26c423](https://github.com/gvmii/revanced-patches/commit/d26c4233031fd418eb37c8f05e9bc1857e0572e6))
* Readd `swipe-controls` patch ([#123](https://github.com/gvmii/revanced-patches/issues/123)) ([7f2a2b2](https://github.com/gvmii/revanced-patches/commit/7f2a2b2ee4e6045d53aba4e7705431b643981107))
* references to integrations in `return-youtube-dislike` patch ([5824c2c](https://github.com/gvmii/revanced-patches/commit/5824c2cdfb1a2d7b8d68044388e5e0746ef2ca09))
* releases ([30d5c9a](https://github.com/gvmii/revanced-patches/commit/30d5c9a67ccf88ca6ac00d0a9f2a2e330f8092dd))
* remove `HideSuggestionsPatch` from `Index` ([f32e474](https://github.com/gvmii/revanced-patches/commit/f32e4747b512c675b807ff5eebfd0b8e66173fba))
* remove broken video-quality patch ([e8d516a](https://github.com/gvmii/revanced-patches/commit/e8d516af896971a09bb9aca8b00e7b7bb57c3dd9))
* remove refreshing home screen not working ([6c24ebe](https://github.com/gvmii/revanced-patches/commit/6c24ebef2fb4f0d58e369ac5bf63e4cab6ca0e80))
* remove requirement for solution [skip ci] ([#271](https://github.com/gvmii/revanced-patches/issues/271)) ([553fad3](https://github.com/gvmii/revanced-patches/commit/553fad3fe1bb79bdf34e9f91c0e1cbfda78e1054))
* remove unnecessary version constraints ([#117](https://github.com/gvmii/revanced-patches/issues/117)) ([1cddf8d](https://github.com/gvmii/revanced-patches/commit/1cddf8d9063da3bbdba0fd7080c8c93768b83a4c))
* remove unused patches ([d12e92a](https://github.com/gvmii/revanced-patches/commit/d12e92aead677fefa9dcb48748d783225b65fab1))
* rename `default-video-quality` to `remember-video-quality` ([7f6cdfd](https://github.com/gvmii/revanced-patches/commit/7f6cdfd7c2b5e72742bbb92e4d584f722cb82cae))
* rename autorepeat-by-default patch to always-autorepeat ([3606015](https://github.com/gvmii/revanced-patches/commit/3606015d715f150cc51fbb29adf3be252b96faab))
* revert `swipe-controls` patch  ([66e1f33](https://github.com/gvmii/revanced-patches/commit/66e1f3384a58361737ba889d946be875b23f3163))
* rollback to `Dependencies` annotation ([36a2ae8](https://github.com/gvmii/revanced-patches/commit/36a2ae886c63f1d22bb1cca9e7110af6c3f6f2d3))
* show minimized playback options in settings ([#118](https://github.com/gvmii/revanced-patches/issues/118)) ([6e1a538](https://github.com/gvmii/revanced-patches/commit/6e1a538d34291d75f19bf66a188bc69241de3a7a))
* signature checker with changes of patcher ([e82459d](https://github.com/gvmii/revanced-patches/commit/e82459d37759e1a5a860d3e7fcdf69d95b06858e))
* some more refactoring of integrations, add hide-watermark patch ([#63](https://github.com/gvmii/revanced-patches/issues/63)) ([feb09c5](https://github.com/gvmii/revanced-patches/commit/feb09c56f475e2537a67d3636b08737848158a8e))
* spelling mistake ([52f9147](https://github.com/gvmii/revanced-patches/commit/52f9147ee8d591f786397d174dc02a141d9250a9))
* spoof `X-Android-Cert` of Firebase `authToken` api request ([#315](https://github.com/gvmii/revanced-patches/issues/315)) ([c81d61f](https://github.com/gvmii/revanced-patches/commit/c81d61f685449590473fa5205e7709f81872a9b9))
* sync version ([6170e36](https://github.com/gvmii/revanced-patches/commit/6170e3689d9c8998be94a8464352af620cccd11b))
* tests failing ([102793f](https://github.com/gvmii/revanced-patches/commit/102793f24f8bf7c7fd254968b29d65da7b2b962f))
* trigger release on `build` commits ([be8bd1b](https://github.com/gvmii/revanced-patches/commit/be8bd1b2a4b91f9763448661a802a5dc4a6b1d1d))
* update `HomeAdsPatch` ([62f1801](https://github.com/gvmii/revanced-patches/commit/62f1801e9cbee53c0be3413c245161bd941e4aec))
* update patcher version ([e3d0bb7](https://github.com/gvmii/revanced-patches/commit/e3d0bb7ee1923ea996cf637267c62d233a74c7fa))
* update patcher version ([5f54bc9](https://github.com/gvmii/revanced-patches/commit/5f54bc9aa8fd8b83448141a9b05746e3e977369d))
* update patcher version ([#35](https://github.com/gvmii/revanced-patches/issues/35)) ([1a379df](https://github.com/gvmii/revanced-patches/commit/1a379dfd974b9f92d4bd0d5d7a4711eb6d1060b3)), closes [#34](https://github.com/gvmii/revanced-patches/issues/34)
* update patches ([91b8ec8](https://github.com/gvmii/revanced-patches/commit/91b8ec81f33417798546c32db708fe09ada3930c))
* update patches to `17.26.35` ([#142](https://github.com/gvmii/revanced-patches/issues/142)) ([b04112c](https://github.com/gvmii/revanced-patches/commit/b04112c8562a7b95e7555e894b665913094b33eb))
* use dependency in correct patch ([a2a1ee8](https://github.com/gvmii/revanced-patches/commit/a2a1ee8eb5e059b30fe58c918a80976ef4d7b637))
* use the latest version of patcher dependency ([fe4a439](https://github.com/gvmii/revanced-patches/commit/fe4a439cb2bc5e385ae13e8e155f25bb15e74633))
* version in package metadata of music ([b299205](https://github.com/gvmii/revanced-patches/commit/b299205aa7cde82f1f55fc598de3ff8d80b8bcb0))
* **VideoAds:** remove `istore1` opcode ([dc4ec57](https://github.com/gvmii/revanced-patches/commit/dc4ec574414c5df959efa0ca8f1cd39a812fedf8))
* wording [skip ci] ([ba64d9e](https://github.com/gvmii/revanced-patches/commit/ba64d9efc3ee606e9bda30ad7f8017af34b1dc3f))
* write while reading resources and remove checking for "." in resource extensions ([7bc6094](https://github.com/gvmii/revanced-patches/commit/7bc60943cb2350e89dac091ec9c98c5effd0b8a9))
* wrong access flag in signature for `Create button patch` ([9fbb89d](https://github.com/gvmii/revanced-patches/commit/9fbb89d05336a256a0759eea6095e073946c45e5))
* wrong annotation and signature in patches ([a0fdee8](https://github.com/gvmii/revanced-patches/commit/a0fdee81a6d6773603520e7c3040ae8637642d58))
* wrong dex path ([170fbbb](https://github.com/gvmii/revanced-patches/commit/170fbbb99e4a2dbe3e0febe44d07a692aa9d7224))
* wrong opcode for `create-button-method` ([3214650](https://github.com/gvmii/revanced-patches/commit/32146506f139aebc44cd5faffb7706b8b9c21c3d))
* wrong opcode pattern for `create-button-method` ([f4d8a85](https://github.com/gvmii/revanced-patches/commit/f4d8a8525bc64b90748b21979d463977a21dcd85))
* wrong opcode pattern for `enable-seekbar-tapping-signature` ([1d83395](https://github.com/gvmii/revanced-patches/commit/1d833957ed3e01188770c85e3d84e483419bd797))
* wrong opcode pattern for signature in `Hide suggestions patch` ([535aee0](https://github.com/gvmii/revanced-patches/commit/535aee08408b990c80f5966c13fa84666a8b35d0))
* wrong patches in `upgrade-tab-remover` ([5182290](https://github.com/gvmii/revanced-patches/commit/518229031ceca049ad790f7b77b19405d39f0ce1))
* wrong signature for `hide-reels-signature` ([2d9ff2a](https://github.com/gvmii/revanced-patches/commit/2d9ff2af0a991d7721f3741187716a3b08bb4029))
* wrong signatures for patch `Old Quality Layout Patch` ([823e503](https://github.com/gvmii/revanced-patches/commit/823e503d84037bdf27b09f17e63383f963c76854))
* wrong versions of patches ([a112b22](https://github.com/gvmii/revanced-patches/commit/a112b22ce6e685204caab6f95f511e26ef95806b))


### Code Refactoring

* migrate from `Signature` to `Fingerprint` ([084078e](https://github.com/gvmii/revanced-patches/commit/084078e7f1852ccd2045e3fa8aedc25a7fd5faa8))
* Rename `net.revanced` to `app.revanced` ([68ea89f](https://github.com/gvmii/revanced-patches/commit/68ea89f15e9ea077df0d0ac20a40b735bb5ae26c))


### Features

* `autorepeat-by-default` patch ([#106](https://github.com/gvmii/revanced-patches/issues/106)) ([e0ac9f3](https://github.com/gvmii/revanced-patches/commit/e0ac9f385fc360f4dd2451e26676633120356c10))
* `compact-header` patch ([83753ba](https://github.com/gvmii/revanced-patches/commit/83753bacf8f56ad16f8abafc02034f1595c12532))
* `custom-branding` patch ([0d65ea8](https://github.com/gvmii/revanced-patches/commit/0d65ea8cdb0e02287f6be6855cd3d28823a61e70))
* `custom-playback-speed` patch ([#50](https://github.com/gvmii/revanced-patches/issues/50)) ([224254b](https://github.com/gvmii/revanced-patches/commit/224254bcce2b394bbfd2549089f0204ce4ed4a89))
* `default-video-quality` patch ([#141](https://github.com/gvmii/revanced-patches/issues/141)) ([609ad7d](https://github.com/gvmii/revanced-patches/commit/609ad7dee7e29b2ecc4e95a93e9dab1646b4b050))
* `Dependencies` annotation ([85806bb](https://github.com/gvmii/revanced-patches/commit/85806bb355e342ecb33d4ee1e76f9edf89b2c2ee))
* `disable-autoplay-button` patch ([#79](https://github.com/gvmii/revanced-patches/issues/79)) ([0d6fb51](https://github.com/gvmii/revanced-patches/commit/0d6fb51e025649aae37e230778ea367482fab0d7))
* `disable-fullscreen-panels` patch ([3bf0561](https://github.com/gvmii/revanced-patches/commit/3bf056163500b006d1a20c5f3a3e0c92fec13bd8))
* `enable-debugging` patch ([#116](https://github.com/gvmii/revanced-patches/issues/116)) ([bb355e7](https://github.com/gvmii/revanced-patches/commit/bb355e7b7e78e602a10b346fe7e5795463615a81))
* `force-vp9-codec` patch ([#157](https://github.com/gvmii/revanced-patches/issues/157)) ([07806a1](https://github.com/gvmii/revanced-patches/commit/07806a16e5368118949e0e476e901987433ad403))
* `general-reddit-ads` patch ([#235](https://github.com/gvmii/revanced-patches/issues/235)) ([d63c016](https://github.com/gvmii/revanced-patches/commit/d63c016d38d2a5b1d152abccdb582990987a1911))
* `GeneralBytecodeAds` and `GeneralResourceAds` patch ([f99bbef](https://github.com/gvmii/revanced-patches/commit/f99bbef4c911ac2492166c7a3792ea11ffceffab))
* `hdr-max-brightness` patch ([#105](https://github.com/gvmii/revanced-patches/issues/105)) ([1310573](https://github.com/gvmii/revanced-patches/commit/131057366a777786d6016d3385584b4e17bc4a8b))
* `hide-cast-button` patch ([2cd531e](https://github.com/gvmii/revanced-patches/commit/2cd531eb5a334f3cf91cba4556f07e863cd9ec1b))
* `hide-get-premium` patch ([#195](https://github.com/gvmii/revanced-patches/issues/195)) ([639aab4](https://github.com/gvmii/revanced-patches/commit/639aab411ee514b50840c15c8e9a1a889854403f))
* `hide-infocard-suggestions` patch ([#107](https://github.com/gvmii/revanced-patches/issues/107)) ([31a767a](https://github.com/gvmii/revanced-patches/commit/31a767adbb152906303ab0ae5250769fc38d0625))
* `hide-shorts-button` patch ([88352ee](https://github.com/gvmii/revanced-patches/commit/88352ee6ecd23faa4a7fd9f7495e67fa1d3e33bd))
* `microg-patch` ([48bbd57](https://github.com/gvmii/revanced-patches/commit/48bbd574a52c8bf6834b26facfe7384b830f944a))
* `minimize-playback-music` patch ([#200](https://github.com/gvmii/revanced-patches/issues/200)) ([d4fd18b](https://github.com/gvmii/revanced-patches/commit/d4fd18bc74c92e17cdfb21b627b2f6a8919ff2dc))
* `music-microg-support` patch ([#208](https://github.com/gvmii/revanced-patches/issues/208)) ([50863e9](https://github.com/gvmii/revanced-patches/commit/50863e97cc8eba7e1ad6d11b4821baa45fdd29c4))
* `music-video-ads` patch ([#172](https://github.com/gvmii/revanced-patches/issues/172)) ([cbb71b5](https://github.com/gvmii/revanced-patches/commit/cbb71b5faf1386ed31dd9e0387f6cf0509d92d31))
* `premium-heading` patch ([78913bf](https://github.com/gvmii/revanced-patches/commit/78913bf1e80f5b91d0dee506fdfe3f875e8e6988))
* `promo-code-unlock` patch ([#292](https://github.com/gvmii/revanced-patches/issues/292)) ([d5df2e6](https://github.com/gvmii/revanced-patches/commit/d5df2e68f47cbb3d374b8ce24769872959014051))
* `ResourceUtils` helper class ([e0e1144](https://github.com/gvmii/revanced-patches/commit/e0e11447a7ac184d43c75955854c52c6992ff667))
* `return-youtube-dislikes` patch ([#175](https://github.com/gvmii/revanced-patches/issues/175)) ([18a66d8](https://github.com/gvmii/revanced-patches/commit/18a66d8454cf6e7cfdd4183631a6870c80d16b90))
* `settings` patch ([0e229a4](https://github.com/gvmii/revanced-patches/commit/0e229a46cb5b8b74183c47a6eae08d667f941406))
* `sponsorblock` patch ([#101](https://github.com/gvmii/revanced-patches/issues/101)) ([36af4cc](https://github.com/gvmii/revanced-patches/commit/36af4cc14ff8057c10b99019cb23acc6e5aec3f2)), closes [#89](https://github.com/gvmii/revanced-patches/issues/89) [#90](https://github.com/gvmii/revanced-patches/issues/90)
* `swipe-controls` override volume button behaviour ([#285](https://github.com/gvmii/revanced-patches/issues/285)) ([69465f3](https://github.com/gvmii/revanced-patches/commit/69465f3a9934973a2449605a248a462510e10ff6))
* `swipe-controls` patch ([#115](https://github.com/gvmii/revanced-patches/issues/115)) ([1d0a7dc](https://github.com/gvmii/revanced-patches/commit/1d0a7dcc0cc3ea2bcd8ce0221d5e2f53d6eb0ae5))
* `swipe-controls` rewrite ([#131](https://github.com/gvmii/revanced-patches/issues/131)) ([b7dba09](https://github.com/gvmii/revanced-patches/commit/b7dba09927ba15a9eacb06dcb4bf1f268560c96e))
* `tablet-mini-player` patch ([dae41f1](https://github.com/gvmii/revanced-patches/commit/dae41f1c59d26d00b1ba821dbe1521e68226f47c))
* `tastebuilder-remover` for music ([a6aeca3](https://github.com/gvmii/revanced-patches/commit/a6aeca31bd80b8c4a8acd071e22faca6e136bdb0))
* `tiktok-ads` patch ([#335](https://github.com/gvmii/revanced-patches/issues/335)) ([81bef57](https://github.com/gvmii/revanced-patches/commit/81bef57742bfaefcdfe02fd290cca6923341149a))
* ˋpflotsh-ecmwf-subscription-unlockˋ patch ([#332](https://github.com/gvmii/revanced-patches/issues/332)) ([ae2a1d8](https://github.com/gvmii/revanced-patches/commit/ae2a1d8362e388032c3521101ff60698c4af1583))
* add "Application Icon Path" option to branding ([1748d1e](https://github.com/gvmii/revanced-patches/commit/1748d1e5badf61213d793ff7ae1d090ea2ea82f0))
* add "Application Name" option to branding and move renaming to CustomBrandingPatch.kt ([8dafe05](https://github.com/gvmii/revanced-patches/commit/8dafe05b2c5e2b0291d46b02717d910721673712))
* Add (WIP) Signature Checker ([ae4c7b2](https://github.com/gvmii/revanced-patches/commit/ae4c7b29f211c461de460f97f3a8656e795adafb))
* add `amoled` patch ([d61bac4](https://github.com/gvmii/revanced-patches/commit/d61bac4f8243d0ef72ca91c7c1d5facd858d515e))
* add `custom-video-buffer` patch ([9f117c7](https://github.com/gvmii/revanced-patches/commit/9f117c74cdbdcf98eae97cf4c37f0baca451d695))
* add compatibility for YouTube v17.23.36 and v17.24.34 ([1812bc3](https://github.com/gvmii/revanced-patches/commit/1812bc39e0e88f1ab02ae8127e9000780eedf49c))
* add home ads patch ([36cddd1](https://github.com/gvmii/revanced-patches/commit/36cddd1488683e19e2b927e34c80a4f0f3cace35))
* add patches compatibility to the newest version ([799401d](https://github.com/gvmii/revanced-patches/commit/799401ddf99da0aaa5f52c39d3d3d4061370fd75))
* add publishing to package registry ([b475e09](https://github.com/gvmii/revanced-patches/commit/b475e09577db4dda7bbb45dbf170d78772834a6d))
* add semantic-release ([d60f1d0](https://github.com/gvmii/revanced-patches/commit/d60f1d06798d312b158b71691ecc87e828dccbc1))
* add youtube version 17.24.35 ([ec626cc](https://github.com/gvmii/revanced-patches/commit/ec626ccfa2bcf14b722d08110382de009a1c12b4))
* add youtube version 17.24.35 ([adc60a6](https://github.com/gvmii/revanced-patches/commit/adc60a6fa09f6a21800ba51b8ca888d11a17e870))
* add youtube version 17.25.34 ([#85](https://github.com/gvmii/revanced-patches/issues/85)) ([889c9d5](https://github.com/gvmii/revanced-patches/commit/889c9d564d16c6e68a52095a4fc8e6d04346c9e9))
* added `codecs-unlock` patch ([e5fd7ce](https://github.com/gvmii/revanced-patches/commit/e5fd7cece94b1ff5342178f59b29576db806e0f6))
* begin `MicroG Patch` ([91474ba](https://github.com/gvmii/revanced-patches/commit/91474ba07376c13e7a71685dfd8b6e6913ed5ee9))
* bump compatibility of patches for Youtube to v17.23.35 ([3748d05](https://github.com/gvmii/revanced-patches/commit/3748d0533e62a8871ab2202ce9b61170a90dae62))
* bump compatibility of YouTube Music patches to v5.16.51 ([#238](https://github.com/gvmii/revanced-patches/issues/238)) ([4fa2a12](https://github.com/gvmii/revanced-patches/commit/4fa2a127d715f953a1e4efacaecbc218209a01f3))
* bump music patches to 5.17.51 ([#307](https://github.com/gvmii/revanced-patches/issues/307)) ([c303589](https://github.com/gvmii/revanced-patches/commit/c303589bd8d1956ce2e3c4c285d45a648b5db30f))
* bump YouTube patches to `v17.32.35` ([#347](https://github.com/gvmii/revanced-patches/issues/347)) ([5292a0e](https://github.com/gvmii/revanced-patches/commit/5292a0e973953225f94eed887a5d8f1ead17bb97))
* bundle `dex` file into `jar` file ([#359](https://github.com/gvmii/revanced-patches/issues/359)) ([f419252](https://github.com/gvmii/revanced-patches/commit/f4192526eab1e3e0208e7460847b892e077fcf5a))
* display metadata for each signature in `SignatureChecker` ([736a71f](https://github.com/gvmii/revanced-patches/commit/736a71fac21a32dbb1eef9c3a9f0d3005e7d9ca0))
* generate & upload dex files ([#18](https://github.com/gvmii/revanced-patches/issues/18)) ([e6f5355](https://github.com/gvmii/revanced-patches/commit/e6f53553a98c164c4eb926fb273358ed506e00a4))
* generate dex files using gradle task ([c34c1be](https://github.com/gvmii/revanced-patches/commit/c34c1be21f50b4f720a7cd81e0dfe5ef6330caab))
* get required register dynamically ([0924ca2](https://github.com/gvmii/revanced-patches/commit/0924ca2ad30ae865dcc0fd484cb0da517e827352))
* hide watermark support for 17.25.34 ([#87](https://github.com/gvmii/revanced-patches/issues/87)) ([0cdb65b](https://github.com/gvmii/revanced-patches/commit/0cdb65bbb3e7b9d75eb393ee87e3718bcd6af4b3))
* implement `wide-searchbar` Patch ([#130](https://github.com/gvmii/revanced-patches/issues/130)) ([332f4d1](https://github.com/gvmii/revanced-patches/commit/332f4d12d06316d65db252a280fe1f263e65c3a8))
* Initial commit ([bee5f2f](https://github.com/gvmii/revanced-patches/commit/bee5f2faed882271ed059b0435e6e1aa91f93dbd))
* integrations patch ([19c0b0d](https://github.com/gvmii/revanced-patches/commit/19c0b0d194bb97c7248ea7a9b081176961653b9d))
* issue templates ([b82b0aa](https://github.com/gvmii/revanced-patches/commit/b82b0aad88b7ab9d86f1bcc8e007f6a76a9aa1a5))
* make resource mapping patch aware of types ([#77](https://github.com/gvmii/revanced-patches/issues/77)) ([188491a](https://github.com/gvmii/revanced-patches/commit/188491a707abccc1164413f075d8a66c145a1455))
* migrate to breaking changes of patcher ([d9147cd](https://github.com/gvmii/revanced-patches/commit/d9147cd60c0c25d0c5cc05409b8889dfacd89af9))
* migrate to dalvik patches ([e088c67](https://github.com/gvmii/revanced-patches/commit/e088c671081bcf75586ccc1c4bdbed9366e93874))
* MinimizedPlayback, CreateButtonRemover ([cc08c6c](https://github.com/gvmii/revanced-patches/commit/cc08c6c3d38879dd4672ec671631b34aa2e3cc77))
* OldQualityLayout, HideSuggestions, HideReels, EnableSeekbarTapping ([04a7cff](https://github.com/gvmii/revanced-patches/commit/04a7cfff20d2734b1c92713de4e7e08a3b93ee85))
* Patches for YouTube Music ([b60c9d3](https://github.com/gvmii/revanced-patches/commit/b60c9d33b611bb4d5b55bb419652bc14b0309792))
* remove `force-vp9-codec` patch ([#287](https://github.com/gvmii/revanced-patches/issues/287)) ([e428978](https://github.com/gvmii/revanced-patches/commit/e42897801b20e7439969954753e2c15c85eb41b5))
* remove obsolete patch `Hide suggestions patch` ([e65c6f2](https://github.com/gvmii/revanced-patches/commit/e65c6f240ed23a54271d20a90fc57ec65cafc02d))
* set the correct theme of the settings screen ([70d850c](https://github.com/gvmii/revanced-patches/commit/70d850cf295d306b0de9419efe6a4bbf3857d3a0))
* twitter `timeline-ads` patch ([#222](https://github.com/gvmii/revanced-patches/issues/222)) ([f16e67f](https://github.com/gvmii/revanced-patches/commit/f16e67fc75c9c3505ff875a216ce7e868022075e))
* update MicroG patch to latest version ([c24f806](https://github.com/gvmii/revanced-patches/commit/c24f8063a04f89aea2d2f7087a435738de7dfeae))
* update patches to latest version ([bad25de](https://github.com/gvmii/revanced-patches/commit/bad25dec1d73137f8b7a1bf4daaceb2279b4d48c))
* updated all patches to support v17.22.36 of `com.android.google.youtube` ([e12dc11](https://github.com/gvmii/revanced-patches/commit/e12dc11b670c2b0c414741616e0a646e8421e418))
* use `install` mode by default ([c2b2993](https://github.com/gvmii/revanced-patches/commit/c2b299336a984d66a2d066e5ebe9c4f9bee5c2aa))
* use supplier instead of KClass ([08af6e5](https://github.com/gvmii/revanced-patches/commit/08af6e54af79ef9ef4fb3372a348ce9b6fba4d20))
* use supplier instead of KClass ([91aa019](https://github.com/gvmii/revanced-patches/commit/91aa019f8d3d87fbf7affeb7abc2b02ba87af5c3))


### Performance Improvements

* fix high battery consumption due to chromecast not working with `microg` ([dd8b01a](https://github.com/gvmii/revanced-patches/commit/dd8b01a5c5d75b00ea4d04ce35bc43942c1b0409))


### Reverts

* Revert "Changed app name to ReVanced (#21)" (#24) ([70a48c5](https://github.com/gvmii/revanced-patches/commit/70a48c5f35cd236612352a1dbbf50487625e6e96)), closes [#21](https://github.com/gvmii/revanced-patches/issues/21) [#24](https://github.com/gvmii/revanced-patches/issues/24)
